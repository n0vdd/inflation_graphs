...
# Import from the original modules in the old package for now
from src.brazil_inflation_graphs.visualizer import BrazilInflationVisualizer, HistoricalEvent
try:
    from src.brazil_inflation_graphs.advanced_analytics import AdvancedInflationAnalytics
except ImportError:
    AdvancedInflationAnalytics = None
try:
    from src.brazil_inflation_graphs.comparative_analysis import ComparativeInflationAnalysis
except ImportError:
    ComparativeInflationAnalysis = None
try:
    from src.brazil_inflation_graphs.monetary_policy import MonetaryPolicyAnalyzer
except ImportError:
